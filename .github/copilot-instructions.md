...
> **Canonical source: `/AGENTS.md`.** If these files diverge, `AGENTS.md` wins. Update both when rules change.

These rules apply to any AI coding assistant working in this repo, regardless of tool or model.
